...
namespace TakeCareOfPlants
{
    public partial class UI_Care : UserControl
    {
        ...
        private void List_Calender_DataGrid_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            if (e.RowIndex != -1) {
                ...
                if (Function_GUI.IsTheSameCellValue(List_Calender_DataGrid, e.ColumnIndex, e.RowIndex)
                    ...
                    e.AdvancedBorderStyle.Top = List_Calender_DataGrid.AdvancedCellBorderStyle.Top;
                }
            }
        }

        private void List_Calender_DataGrid_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.RowIndex == 0) {
                return;
            }
            ...
            try {
                ...
                foreach (Tuple<Lich_DTO, TimeSpan, string, string, int, string> tuple in listCalender) {
                    ...
                    if (List_Calender_DataGrid.Rows.Count > 1) {
                        if (!List_Calender_DataGrid.Rows[List_Calender_DataGrid.Rows.Count - 1].Cells[1].Value
                            .Equals(List_Calender_DataGrid.Rows[List_Calender_DataGrid.Rows.Count - 2].Cells[1].Value)) {
